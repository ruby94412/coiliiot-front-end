...
const deviceSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(getDeviceList.fulfilled, (state, action) => [...action.payload.data])
      .addCase(addDevice.fulfilled, (state, action) => ({ ...action.payload.data }))
      .addCase(updateDevice.fulfilled, (state, action) => ({ ...action.payload.data }))
      .addCase(deleteDevice.fulfilled, (state, action) => ({ ...action.payload.data }));
  },
